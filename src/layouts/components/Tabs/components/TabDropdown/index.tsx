  ...
  const content = (
    <ul className="pt-2 w-[140px]">
      <li className="px-2 py-1 cursor-pointer">
        <div className="flex items-center  hover:bg-[#f5f5f5] rounded-[4px]">
          <Icon icon="lucide:x" />
      ...
      <li className="px-2 py-1 pb-2 cursor-pointer border-b-solid border-b-[#f0f0f0] border-b-1">
        <div className="flex items-center  hover:bg-[#f5f5f5] rounded-[4px]">
      ...
      <li className="px-2 py-1 cursor-pointer border-b-solid border-b-[#f0f0f0] border-b-1">
        <div className="flex items-center  hover:bg-[#f5f5f5] rounded-[4px]">
